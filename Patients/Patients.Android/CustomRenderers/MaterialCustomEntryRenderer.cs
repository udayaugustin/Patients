...
[assembly: ExportRenderer(typeof(MaterialEntry), typeof(CustomEntryRenderer), new[] { typeof(VisualMarker.MaterialVisual) })]
public class MaterialCustomEntryRenderer : MaterialEntryRenderer
{
    private readonly Context context;
    private TextInputLayout textInputLayout;

    public MaterialCustomEntryRenderer(Context context) : base(context)
    {
